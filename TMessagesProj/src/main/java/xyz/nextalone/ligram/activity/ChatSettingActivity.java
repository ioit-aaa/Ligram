...
package xyz.nextalone.ligram.activity;

import static xyz.nextalone.ligram.UIKt.createMessageFilterSetter;
...
import xyz.nextalone.ligram.ui.StickerSizePreviewMessagesCell;
import xyz.nextalone.ligram.ui.sortList.ItemTouchHelperCallback;
import xyz.nextalone.ligram.ui.sortList.SortListAdapter;
import xyz.nextalone.ligram.ui.sortList.TextStyleListAdapter;
            ...
            switch (holder.getItemViewType()) {
                ...
                case TYPE_SETTINGS: {
                    ...
                    if (position == stickerSizeRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("MarkdownParser", R.string.MarkdownParser), Config.newMarkdownParser ? "Ligram" : "Telegram", payload,
