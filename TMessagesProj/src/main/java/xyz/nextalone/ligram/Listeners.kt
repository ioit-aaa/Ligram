...
class LigramPushService : NotificationListenerService() {
...
class SaveToDownloadReceiver : BroadcastReceiver() {
    companion object {
        ...
        private const val ACTION_CANCEL = "xyz.nextalone.ligram.SAVE_TO_DOWNLOAD_CANCEL"
        private const val EXTRA_ID = "xyz.nextalone.ligram.NOTIFICATION_ID"
